...
!function (e, n) {
	"object" == ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : (void 0).finger = n();
}(0, function () {
	var t = function (t) {
		...
		n = "undefined" != typeof top && top.btoa || function (n) {
			for (var o = [], s = 0, c = n.length, i = 0, r = 0; r < c; ++r)
			{
				3 === (s += 1) && (s = 0),
