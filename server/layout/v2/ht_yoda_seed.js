...
(function (f) {
		...
		function F(a, b, c)
		{
			...
			{
				throw window.Yoda.CAT.postBatch(a, 0, 0, Date.now() - C, "500|0", "ajax"),
					window.Yoda.CAT.sendBatch(),
					window.Yoda.CAT.sendLog(a, "ajaxError", "[\u8bf7\u6c42\u5f02\u5e38]", G.message),
		...
		function H(a, b)
		{
			for (var c in b)
			{
				b.hasOwnProperty(c) && b[c] && (a[c] = b[c]);
			}
			return a
		}
		...
		e.prototype.confBack = function (a) {
			if (1 === a.status && a.data)
			{
				...
				this.config = b;
				this._yoda_config || (this._yoda_config = JSON.stringify(b),
					this._yoda_options = JSON.stringify(this.options),
					this._yoda_listIndex = a.data.defaultIndex || 0,
			...
			{
				f.Yoda.CAT.sendLog(z[this.env] + "/v2/ext_api/page_data", "jsError", "[dataException]:\u8bf7\u6c42pageData\u63a5\u53e3\u672a\u6b63\u5e38\u8fd4\u56de\u6570\u636e, \u73af\u5883\u4fe1\u606f\u4e3a:" + this.source, JSON.stringify(a)),
					this.handleError(a)
			}
		}
		;
		e.prototype.ensureVersion = function (a, b) {
			...
			{
				f.Yoda.CAT.sendLog(z[this.env] + "/v2/ext_api/page_data", "jsError", "[dataException]:\u89e3\u6790pageData\u63a5\u53e3\u6570\u636e\u5931\u8d25, \u73af\u5883\u4fe1\u606f\u4e3a:" + this.source, d.message),
				...
				function b(b)
				{
					return function (c, d, g) {
						...
						e.onload = function () {
							...
							"function" === typeof g && g();
							"pro" !== a.env && (f.YODA_CONFIG.__API_URL__ = z[a.env],
								a.setDomain(z[a.env]))
						}
						;
						e.onerror = function () {
		...
		e.prototype.moduleInit = function () {
			if (r && t)
			{
				...
				if ("function" === typeof f.Yoda[g])
				{
					return this[g].initModule = new f.Yoda[g](this.config),
						!1;
				}
		...
		e.prototype.getSourcePath = function () {
			...
			m = m ? m + "." : "";
			k = k ? k + "." : "";
			"development" === this.env ? (a = "i" === a ? "mobile" : "desktop",
				w = "/modules/" + g + "/" + a + "/" + g + ".js",
				B = "/modules/" + g + "/" + a + "/" + g + ".css",
				A = "./yoda-" + a + ".js") : (A = "https://static.meituan.net/bs/yoda-static/file:file/" + a + "/js/yoda." + m + "js",
				w = "https://static.meituan.net/bs/yoda-static/file:file/" + a + "/js/" + g + "." + k + "js")
		}
		;
		...
		e.prototype.setDomain = function (a) {
			setTimeout(function () {
				window.YODA_CONFIG.__API_URL__ = a
			}, 0)
		}
		;
		...
		e.prototype.filter = function () {
			...
			if (a[0] && 1 === a.length)
			{
				D = this.config.riskLevel;
			}
			else
			{
				a = JSON.parse(this.config.riskLevelInfo);
				for (var b = JSON.parse(this.config.verifyMethodVersion), c = this.config.riskLevel.split("|"), d = this.config.defaultIndex || 0; d < c.length; d++)
				{
		...
		x.prototype.report = function (a, b, c) {
			...
			this.addToSendQueue(d, a)
		}
		;
		x.prototype.addToSendQueue = function (a, b) {
			var c;
			(c = this.sendQueue[a.channel]) ? c = c.data : (c = [],
				this.sendQueue[a.channel] = {
					conf: a,
					data: c
				});
			c.push(b);
		...
		x.prototype.sendStatic = function (a, b) {
			...
			{
				throw Error("\u7075\u7280XHR\u8bf7\u6c42\u670d\u52a1\u5668\u53d1\u751f\u5f02\u5e38: " + d.message);
			}
			return !0
		}
		;
		...
		n.prototype.speed = function (a, b) {
			var c = "&project=" + this.project + "&pageurl=" + window.location.href + "&unionId=" + this.unionId + "&timestamp=" + Date.now() + "&speed=" + a + "&customspeed=" + b;
