...
// 					imgWrapper: 'yodaImageWrapper',
// 					img: 'yodaImg',
// 					changeImg: 'yodaChangeImg',
// 					input: 'yodaCodeInput',
// 					sure: 'yodaSure',
// 					tip: 'yodaTip' }
				var e = {};
		...
		, function (t, i, a) {
			...
			var c = function t() {
				...
				var s = function () {
					...
					inputs: [],
					buttons: [{
						"buttonName": "rohr_76847",
						"touchPoint": "{360,231}",
						"touchPosition": "{35.6,71}",
				...
				return t[Q1] = function () {
					...
					t[De] = function (e) {
						var n, r = {};
// 						t = {"v":"2.0.1","rId":"100009","ts":1555419723249,"cts":1555421568158,"brVD":[800,600],"brR":[[1920,1080],[1920,1040],24,24],"bI":["https://epassport.meituan.com/account/unitivelogin?bg_source=3&service=waimai&platform=2&continue=http://e.waimai.meituan.com/v2/epassport/entry&left_bottom_link=%2Faccount%2Funitivesignup%3Fbg_source%3D3%26service%3Dwaimai%26platform%3D2%26continue%3Dhttp%3A%2F%2Fe.waimai.meituan.com%2Fv2%2Fepassport%2FsignUp%26extChannel%3Dwaimaie%26ext_sign_up_channel%3Dwaimaie&right_bottom_link=%2Faccount%2Funitiverecover%3Fbg_source%3D3%26service%3Dwaimai%26platform%3D2%26continue%3Dhttp%3A%2F%2Fe.waimai.meituan.com%2Fv2%2Fepassport%2FchangePwd","http://e.waimai.meituan.com/logon"],"mT":["516,183,1814490","509,183,1814473","499,183,1814457","483,183,1814440","477,183,1814427","476,183,1814340","471,183,1814324","456,183,1814307","440,183,1814291","423,185,1814273","406,185,1814257","368,185,1814238","341,185,1814207","325,185,1814195","315,185,1814188","314,185,1813907","317,186,1813891","321,188,1813873","322,189,1813859","326,189,1813771","329,191,1813691","331,191,1813675","332,192,1813657","339,196,1813641","344,197,1813624","348,198,1813607","350,201,1813591","352,202,1813574","356,202,1813557","358,203,1813540","367,207,1813523","370,209,1813507","376,213,1813490","379,214,1813473","381,215,1813457","385,219,1813440","387,220,1813427","388,221,1813411","390,222,1813403","392,224,1813384","415,237,1812673","414,236,1812623","414,235,1812612","414,232,1812590","414,231,1812574","414,230,1812563","414,229,1812540","414,226,1812524","414,225,1812507","414,223,1812490","416,212,1812457","420,203,1812441","422,196,1812424","423,188,1812407","424,177,1812391","427,160,1812357","427,155,1812340","430,150,1812323","432,148,1812307","437,144,1812290"],"kT":[],"aT":["414,237,BUTTON,1812771","542,63,A,1812043","360,231,BUTTON,905836","538,77,A,904428"],"tT":[],"aM":"","inputs":[],"buttons":[{"buttonName":"rohr_76847","touchPoint":"{414,237}","touchPosition":"{55,55.2}","touchTimeStamp":1555421536020}],"broP":["Chrome PDF Plugin","Chrome PDF Viewer","Native Client"],"sign":"eJy1j7EOwjAMRP+lQ8ZGKhtSxcAPsDBHaXBbi8SOEqeFv6cVDFUHBiQW6+ST3t1V3WAyl+SgPSjHJEgF2lEkHrWGerYYLNYBUIql2nHQU6Mh2pwjJ9FAkp7KQy+mYxEOxiPdW22d40KiC6HgBBkHKvG0zcqQJlzUO0FFb6XnFNrmhxYr/hoVPOQ8WiLwHyqsL7O6pkTjdt4mMuEwfl+QwPFy/zZhLTfAZb7tqNULOIOeWA=="}
		...
		, function (t, e, i) {
			...
			a[uc][be] = function (t, e) {
				...
				while ((c[p3] > f || c[i3] === f) && i !== I);
				return a === g ? (i = _[T3](this[r3]),
					this[E3](i),
					this[e3] = o,
				i === E) : a === S ? (this[E3](E),
					c[i3] = f,
		...
		, function (t, e, r) {
			...
			function w(t, e)
			{
				var n, r, i = t[P3], o = t[X3], a = t[J3], c = t[G3], s = t[X3] > t[z3] - gt ? t[X3] - (t[z3] - gt) : f,
					u = t[q3], d = t[$3], _ = t[Q3], v = t[X3] + yt, w = u[o + a - l], h = u[o + a];
				t[J3] >= t[t4] && (i >>= p),
				c > t[e4] && (c = t[e4]);
				do
				{
					...
					u[n + a] === h && u[n + a - l] === w && u[n] === u[o] && u[++n] === u[o + l])
					{
						...
						while (u[++o] === u[++n] && u[++o] === u[++n] && u[++o] === u[++n] && u[++o] === u[++n] && u[++o] === u[++n] && u[++o] === u[++n] && u[++o] === u[++n] && u[++o] === u[++n] && o < v);
						if (r = yt - (v - o),
							o = v - yt,
						r > a)
						{
			...
			function R(t, e)
			{
				for (var r, i, a, c, s = t[q3]; ;)
				{
					...
					i === s[++a] && i === s[++a] && i === s[++a]))
					{
						...
						while (i === s[++a] && i === s[++a] && i === s[++a] && i === s[++a] && i === s[++a] && i === s[++a] && i === s[++a] && i === s[++a] && a < c);
						t[d4] = yt - (c - a),
						t[d4] > t[e4] && (t[d4] = t[e4])
					}
			...
			var B, V = r(Os), M = r(of), U = r(dc), X = r(ws), Z = r(Ns), Y = f, K = l, P = Se, J = Tn, G = ui, z = f,
				q = l, $ = -p, Q = -Se, tt = -ui, et = -l, nt = l, rt = p, it = Se, ot = Tn, at = f, ct = p, st = Wi,
				ut = Bi, ft = Yi, lt = Wi, dt = E, _t = D3, vt = _t + l + dt, wt = y, ht = Na, bt = p * vt + l, pt = Yi,
				mt = Se, yt = H3, gt = yt + mt + l, Et = S, It = Pu, St = lu, Ot = rf, Rt = qs, Tt = zc, kt = Es,
				Ct = x3, At = l, Nt = p, Dt = Se, Ht = Tn, xt = Se;
		...
		, function (t, e, r) {
			...
			function h(t, e)
			{
				var n, r, i, o, a, c, s = e[g0], u = e[E0], d = e[I0][w0], _ = e[I0][y0], v = e[I0][h0], w = e[I0][b0],
					h = e[I0][m0], b = f;
				for (o = f; o <= it; o++)
				{
					t[F4][o] = f;
											...
											return n = i = ri,
												a ? O = a == p ? function (t, e) {
													...
													: (i = [H5, ba, D5, N5, x5, Qi, O1],
															O = function (t, e) {
																var n, o, a = C[r](t) == N,
																	c = !a && typeof t[O1] != at && v[typeof t[Qi]] && t[Qi] || E;
																for (n in t)
																{
																	a && n == uc || !c[r](t, n) || e(n);
																}
